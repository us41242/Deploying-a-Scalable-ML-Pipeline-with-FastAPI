...
from ml.model import train_model, inference, compute_model_metrics, \
                     performance_on_categorical_slice, save_model  # noqa: E402
...
def run_pipeline():
    ...
    train, test = train_test_split(
        data, test_size=0.20, random_state=42, stratify=data[LABEL_COLUMN]
    )
    ...
    # Computes performance on data slices
    ...
    with open(SLICE_OUTPUT_PATH, 'w') as f:
        ...
        for feature in CAT_FEATURES:
            ...
            for slice_name, metrics in slice_metrics.items():
                # Extract the original value from the slice_name
                if '_' in slice_name and slice_name.startswith(feature + '_'):
                    original_value = slice_name.split('_', 1)[1]
                else:
                    original_value = slice_name
